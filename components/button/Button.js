...
function Button({ label = "label", type = "", leftIcon, rightIcon }) {
  let btnType = type == "outline" ? "text-primary-200 bg-primary-200/0 hover:bg-primary-200/25 hover:text-primary-400" : "hover:bg-primary-400";
  ...
  return (
    <Link href={'#'} className={`duration-150 border-2 border-primary-200 hover:border-primary-400 border-box bg-primary-200 inline-block text-dark-950 py-4 px-11 ${btnType} ${btnLeftIcon} ${btnRightIcon} rounded-lg`}>
