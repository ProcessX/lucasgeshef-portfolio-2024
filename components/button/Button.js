...
function Button({ label = "label", type = "", leftIcon, rightIcon }) {
  ...
  return (
    <Link href={'#'} className={`duration-150 border-2 border-primary-200 hover:border-primary-300 border-box bg-primary-200 inline-block text-dark-950 py-4 px-11 ${btnType} ${btnLeftIcon} ${btnRightIcon} rounded-lg`}>
